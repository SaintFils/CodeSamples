...
namespace ECSTest.Systems
{
    ...
    public partial struct ReloadingSystem : ISystem
    {
        ...
        public partial struct ReloadingJob : IJobEntity
        {
            ...
            private void Execute(ref AttackerComponent attacker, ref AttackerStatisticComponent statistic, 
                in PositionComponent position, Entity attackerEntity)
            {
            ...
            private void ReloadIfNecessary(ref AttackerComponent attacker, ref AttackerStatisticComponent statistic, 
                int reloadCost, float2 position)
            {
                Reload(ref attacker);
